...
%{
  ...
  val balance: Int = 0;
  val commentbalance: Int = 0;
  val action_line: Int = 0;
  val actionText: StringBuilder = StringBuilder();

  val isYYEOF: Boolean = false;
  val notUnix: Boolean = false;
  val caseless: Boolean = false;
  val inclusive_states: Boolean = false;

  val nextState: Int = 0;

  val macroDefinition: Boolean = false;
